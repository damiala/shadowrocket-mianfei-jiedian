...
> 面向 iPhone 和 iPad 用户的 Shadowrocket 免费节点订阅入口。
...
| --- | --- |
| 更新日期 | 2026年9月10日 |
| 自动同步时间 | 2026年9月10日 00:00 |
| 当天文章 | https://free.yunxiang.lol/posts/nodes/2026-09-10 |
| 订阅格式 | XBoard 通用订阅 |
...
```text
https://free.yunxiang.lol/posts/nodes/2026-09-10
```

请打开上面的博客文章，在正文“免费订阅地址”区域获取当天可用入口。移动端复制容易出错，统一回到正文可以减少旧地址和截图传播。

## 快速入口

- 今日免费节点文章：https://free.yunxiang.lol/posts/nodes/2026-09-10
...
- 内容重点：Shadowrocket 订阅、iOS VPN 权限、移动网络切换和复制排错；2026年9月10日更新；香港、日本、新加坡、美国 等地区；100 Mbps 公共限速
- 固定入口：https://free.yunxiang.lol/

## 今日导入路径

1. 打开今日文章，确认日期是 2026年9月10日，再获取正文里的免费订阅入口。
...
- Shadowrocket 用户优先确认 iOS VPN 权限，再复制当天文章里的订阅入口。
...
本站每日北京时间 00:00 自动处理免费节点用户：重置流量、刷新订阅 Token、写入服务端动态数据，并同步 GitHub 分享仓库。Shadowrocket 用户优先确认 iOS VPN 权限，再复制当天文章里的订阅入口。 仓库里的 `sub/latest.txt` 只保存当天文章链接，不保存真实订阅地址。
